...
# installs, and that sre.server.baseline and the three roles it composes resolve by their fully
...
ansible-galaxy collection install --collections-path "$work_dir/collections" -- "$work_dir"/sre-server-*.tar.gz
